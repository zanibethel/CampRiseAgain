...
export default function VolunteerPage() {
  ...
  function submit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const subject = `Camp Rise Again volunteer - ${fullName}`;
      const body = [
        "Hi Tierra,",
        "",
        "I completed the Camp Rise Again volunteer form on the website. My responses are below:",
        "",
        "VOLUNTEER FORM",
        "--------------",
        `Name: ${fullName}`,
